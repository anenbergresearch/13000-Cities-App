...
layout = html.Div([
    html.Div([
        html.Div(style={'backgroundColor': colors['background']}, children=[html.H1(children='Cities Scatter Plot', style={'textAlign': 'center','color': 'black'}),html.Div(children='Exploring Individual Cities', style={'textAlign': 'center','color': 'lightgray'})]),
